...
#make origin-destination matrix for 2010, 2012
...
netchange10_12 <- net12 - net10

colnames(netchange10_12) <- c(1:47)
rownames(net_cov)<- c(1:47)

formula <- netchange10_12 ~ edges + sender("quake") + receiver("quake") + sender("pop")  + receiver("pop")+ sender("tfr_diff")  + receiver("tfr_diff")+ ttriads(alpha = 0.8)+ mutual(alpha = 0.8)
